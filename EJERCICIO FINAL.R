...
### Fecha: todos los grupos deberan entregar el trabajo el dia 3 de diciembre,
#independientemente de que su presentacion sea el dia 3 o el dia 4. De esta forma, 
